import { U as InjectionToken, W as Injector, et as NgZone, ii as makeEnvironmentProviders, jn as formatRuntimeError, lt as RuntimeError, oa as ɵɵdefineInjectable, sa as ɵɵdefineInjector, ua as ɵɵinject, xr as inject } from "./_resource-chunk-DMTbwoSS.js";
import { Ha as ɵɵdefineNgModule, Nn as NgModule, Vt as ApplicationRef, fi as provideAppInitializer, ki as setClassMetadata, xn as Injectable } from "./core-CWWaK1J-.js";
import { $t as NEVER, Ct as take, Qn as Subject, Xt as filter, b as switchMap, rr as Observable, vn as map } from "./esm5-ChK3bs0s.js";
	...
	constructor(serviceWorker, injector) {
		...
		if (!serviceWorker) this.worker = this.events = this.registration = new Observable((subscriber) => subscriber.error(new RuntimeError(5601, (typeof ngDevMode === "undefined" || ngDevMode) && ERR_SW_NOT_SUPPORTED)));
			...
			const messageListener = (event) => {
				const { data } = event;
				if (data?.type) _events.next(data);
			};
			serviceWorker.addEventListener("message", messageListener);
			(injector?.get(ApplicationRef, null, { optional: true }))?.onDestroy(() => {
...
var SwPush = class SwPush {
	...
	static ɵfac = function SwPush_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || SwPush)(ɵɵinject(NgswCommChannel));
	};
...
var SwUpdate = class SwUpdate {
	...
	static ɵfac = function SwUpdate_Factory(__ngFactoryType__) {
		return new (__ngFactoryType__ || SwUpdate)(ɵɵinject(NgswCommChannel));
	};
	static ɵprov = /* @__PURE__ */ ɵɵdefineInjectable({
		token: SwUpdate,
...
var ServiceWorkerModule = class ServiceWorkerModule {
	...
	static ɵmod = /* @__PURE__ */ ɵɵdefineNgModule({ type: ServiceWorkerModule });
	static ɵinj = /* @__PURE__ */ ɵɵdefineInjector({ providers: [SwPush, SwUpdate] });
};
(() => {
